...
import { LayoutDashboard, FileText, ArrowRight, Boxes, Sparkles, Calendar, Info, ChevronRight } from "lucide-react";
...
export default function MainPage() {
        ...
        const fetchLatestMajor = async () => {
            try {
                ...
                if (major) {
                    setLatestMajor({
                        ...major,
                        formattedBody: formatReleaseBody(major.body)
                    });
                }
            } catch (e) {
                console.error("Failed to fetch major release:", e);
            } finally {
                setLoading(false);
            }
        };
    ...
    return (
        <div className="flex flex-col flex-1 p-6 max-w-6xl mx-auto w-full gap-12">
            <section>
                    ...
                    <div className="relative z-10 flex flex-col gap-5 md:gap-6">
                        ...
                        <Dialog>
                            ...
                            <DialogContent className="max-w-[95vw] sm:max-w-xl bg-card border-border shadow-2xl rounded-2xl p-0 overflow-hidden">
                                ...
                                <div className="p-5 md:p-6 max-h-[60vh] overflow-y-auto custom-scrollbar">
                                    <div
