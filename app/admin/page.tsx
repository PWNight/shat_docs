...
type TabType = "groups" | "users" | "sessions" | "logs" | "requests";
                                ...
                                <div className="flex sm:flex-row flex-col gap-2 mt-auto">
                                    <Button
                                        ...
                                        onClick={() => {
                                            setGroupDrafts((prev) => ({
                                                ...prev,
                                                [group.id]: { name: group.name, fk_user: String(group.fk_user) },
                                            }));
                                    ...
                                    >
                                        ...
                                        {item.status === "pending" && (
                                            <Button
                                                ...
                                                onClick={() => setResetRequestDialogId(item.id)}
                                            >
                                                Обработать заявку
                                            </Button>
                                        )}
